  ...
  return (
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 px-6 md:px-12 lg:px-24 py-6 flex justify-between items-center transition-colors duration-300 ${isDark ? 'text-white bg-brand-plum-900/85 backdrop-blur-md' : 'text-brand-plum bg-brand-gold/90 backdrop-blur-md'}`}
      >
        <Logo variant={theme} />
