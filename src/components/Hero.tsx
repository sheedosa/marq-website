...
export default function Hero() {
  ...
  return (
    <section id="top" className="relative min-h-screen flex items-center pt-28 pb-16 px-6 md:px-12 lg:px-24 overflow-hidden">
      ...
      {/* content panel — semi-transparent plum backdrop so text reads over the video */}
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="bg-brand-plum/80 backdrop-blur-sm rounded-2xl px-8 py-10 md:px-12 md:py-14 lg:px-16 lg:py-16">
          {/* tags */}
          <motion.div
